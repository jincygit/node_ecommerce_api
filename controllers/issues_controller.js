...
module.exports.issues_filtering = async function(req, res){
    try{
            ...
            if(req.body.inputdata){
                ...
                const filteredData = [...titleIssues, ...descriptionIssues];
            ...
            // filter with author
            if(req.body.author){
                var filteredData = await Issues.find({author: {$regex: req.body.author, $options: "i"},project: req.body.project}); 
                console.log(filteredData);
            }
            ...
            if(req.body.labels){
                ...
                var filteredData = await Issues.find({ labels: { $in: labels_array },project: req.body.project }); 
